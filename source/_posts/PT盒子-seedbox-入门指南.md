...
tags:
  - pt盒子
  - 刷流
cover: https://img.baiwei.site/img/PT盒子-seedbox-入门指南-005.png
categories:
  - PT
---
...
- nc
  ...
  2. 修改**Current driver** 
     ...
     ![pt-001](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-001.png)

  3. 选择镜像，并选择大分区，其他选择默认即可

     ![pt-008](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-008.png))

     ![pt-009](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-009.png)
...
![pt-003](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-003.png)

#### 修改连接的端口号默认为45000

![pt-002](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-002.png)
...
![pt-007](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-007.png)

![pt-006](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-006.png)
...
![pt-005](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-005.png)

因为最近一直再折腾，数据不是很稳定。

#### 开启数据统计

![pt-004](https://img.baiwei.site/img/PT盒子-seedbox-入门指南-004.png)
